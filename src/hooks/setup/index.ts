/*
 * @Author: dyb-dev
 * @Date: 2025-07-26 13:27:59
 * @LastEditors: dyb-dev
 * @LastEditTime: 2025-07-26 13:28:10
 * @FilePath: /react-web-template/src/hooks/setup/index.ts
    ...
    useEffect(() => {
        ...
        if (__PROJECT_INFO__.env.VITE_DARK === "true") {
            ...
            return () => {
                ...
                _darkModeMediaQuery.removeEventListener("change", _updateTheme)
